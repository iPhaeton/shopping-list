...
(Leaving a list you do not own — item 10 in `backlog/backlog.txt` — shipped in step 19, below.)
...
- **step 19, leave list (steps 1-3)** — only a reader/writer's own row uses the `leave_list` RPC;
