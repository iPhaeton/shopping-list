...
sources: [ai/tasks/12-rename-shoppingloop/description-step-1.md, ai/tasks/12-rename-shoppingloop/implementation-log-step-1.md, ai/marketing/reconciled-naming-research.md, app.json, supabase/config.toml]
...
- `sender_name` reaches the cloud project only through `npx supabase config push` (the user's step,
  no dry run) — read the dashboard's SMTP sender, not this file, to know what real mail says.
