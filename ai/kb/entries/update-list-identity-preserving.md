...
related: [ids-minted-outside-reducer]
---
...
the same list it was given. `item/toggled` leans on the second case — it returns `list` untouched
when the item id is not in that list.
