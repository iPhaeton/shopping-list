...
sources: [ai/tasks/3/implementation-log-step-1.md, jest.setup.ts, src/lib/ids.ts]
last_verified: 2026-08-31
verify: grep -q "jest.mock('expo-crypto'" jest.setup.ts && grep -q '"<rootDir>/jest.setup.ts"' package.json
...
in each suite. Retire this entry if the app stops minting ids on the client.
